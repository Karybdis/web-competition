...
//    List<Competition> findAll();
    ...
    @Query(value="SELECT auto_increment FROM information_schema.`TABLES` WHERE TABLE_SCHEMA='CompetitionDB' AND TABLE_NAME='competition'",nativeQuery = true)       //获取下一个插入数据的ID
    Long getIncId();
